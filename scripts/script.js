...
// "No" button phrases
const phrases = [
    "No", "¿Estás segura?", "¿En serio?", "¡Piénsalo bien!",
    "¡Podemos salir a comer!", "No quiero que presiones NO", "¿Por favor?", "¡Tengo snacks!",
    "Mira el otro botón ->", "Error 404: No no encontrado"
];
let phraseIndex = 0;
...
window.acceptProposal = function () {
    ...
    setTimeout(() => {
        ...
        if (whatsappBtn) {
            ...
            whatsappBtn.style.transition = 'opacity 1s ease';
            setTimeout(() => {
